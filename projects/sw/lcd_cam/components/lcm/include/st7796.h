...
/**
 * @brief Structure to store config information of st7796 lcm driver
 */
typedef struct {
...
/**
 * @brief Structure to store handle information of st7796 lcm driver
 */
typedef struct {
    /**
     * @brief Write data
...
/**
 * @brief Uninitialize the st7796 lcm driver
 *
...
/**
 * @brief Initialize the st7796 lcm driver
 *
