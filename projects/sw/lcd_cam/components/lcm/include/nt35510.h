...
/**
 * @brief Structure to store config information of nt35510 lcm driver
 */
typedef struct {
...
/**
 * @brief Structure to store handle information of nt35510 lcm driver
 */
typedef struct {
    /**
     * @brief Write data
...
/**
 * @brief Uninitialize the nt35510 lcm driver
 *
...
/**
 * @brief Initialize the nt35510 lcm driver
 *
